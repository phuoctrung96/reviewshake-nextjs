...
import { getLastSixMonths, monthNames } from '@/utils/formatDate';
import { BarChartType } from '../bar-chart/BarChart';
import { sampleData } from './profilePageData';
import { StyledProfilePageChartsWr } from './profilePageCharts.styles';
