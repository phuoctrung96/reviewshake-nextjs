...
import { StyledLineChartWrDiv, StyledCustomSliceTooltipWr } from './lineChart.styles';
...
const LineChart = ({
  ...
  return (
    <StyledLineChartWrDiv style={{ height: wrapperHeight }}>
      <ResponsiveLine
        data={chartData}
        margin={
          chartStyle === 'simple'
